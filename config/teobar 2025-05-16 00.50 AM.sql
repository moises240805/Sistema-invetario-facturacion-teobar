...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2025 a las 06:56:52
...
(2, 'Caja Secundaria transferencias y pago movil', 469.61);
...
(151, 17, 39.00, 7.00, 3, 0.00, 0),
(152, 18, 41.00, 18.00, 3, 0.00, 0),
(153, 19, 24.00, 45.00, 4, 0.00, 0),
(154, 66, 22.00, 23.00, 3, 0.00, 0),
(155, 345, 11.00, 11.00, 4, 11.00, 0),
(156, 345, 0.00, 0.00, 1, 1.00, 0),
(157, 345, 0.00, 0.00, 2, 1000.00, 0);
...
(17, 'Refresco BigCola 2lt', '', '2025-03-27', '2025-04-05', 0, 0, 20, 'views/img/productos/Refresco BigCola 2lt.jpg', 1),
(18, 'Azucar La Pastora 1k', '', '2025-03-27', '2025-04-05', 0, 0, 23, 'views/img/productos/Azucar La Pastora 1k.jpg', 1),
...
(66, 'pasta larga', 'waker', '2025-04-14', '2025-05-10', 0, 0, 1, 'views/img/productos/logaritmo.png', 1),
(98, 'pasta', '', '2025-03-27', '2025-04-05', 0, 0, 1, 'views/img/productos/prueba.png', 1),
(345, 'Moises Pereira', 'natulac', NULL, '2025-06-07', 0, 0, 1, NULL, 1);
...
--
ALTER TABLE `accesos`
  MODIFY `id_accesos` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=309;
