...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2025 a las 21:40:34
...
(1, 1, 'Apertura', 240.16, '2025-05-16'),
(2, 2, 'Apertura', 240.16, '2025-05-16'),
(3, 1, 'Cierre', 240.16, '2025-05-16'),
(4, 2, 'Cierre', 240.16, '2025-05-16'),
(5, 1, 'Apertura', 0.00, '2025-05-16'),
(6, 2, 'Apertura', 0.00, '2025-05-16'),
(7, 1, 'Cierre', 0.00, '2025-05-16'),
(8, 2, 'Cierre', 0.00, '2025-05-16'),
(15, 1, 'Apertura', 0.00, '2025-05-16'),
(16, 2, 'Apertura', 0.00, '2025-05-16'),
(17, 1, 'Cierre', 0.00, '2025-05-16'),
(18, 2, 'Cierre', 0.00, '2025-05-16'),
(21, 1, 'Apertura', 240.16, '2025-05-16'),
(22, 2, 'Apertura', 485.85, '2025-05-16'),
(23, 1, 'Cierre', 240.16, '2025-05-16'),
(24, 2, 'Cierre', 506.73, '2025-05-16'),
(25, 1, 'Apertura', 240.16, '2025-05-16'),
(26, 2, 'Apertura', 506.73, '2025-05-16'),
(27, 1, 'Cierre', 240.16, '2025-05-16'),
(28, 2, 'Cierre', 506.73, '2025-05-16'),
(29, 1, 'Apertura', 240.16, '2025-05-17'),
(30, 2, 'Apertura', 506.73, '2025-05-17'),
(33, 1, 'Cierre', 240.16, '2025-05-17'),
(34, 2, 'Cierre', 506.73, '2025-05-17');
...
(1, 'Caja Principal efectivos y divisas', 240.16, 0),
(2, 'Caja Secundaria transferencias y pago movil', 506.73, 0);
...
(1, 37.00, 7.00, 3, 0.00, 0),
(2, 40.00, 18.00, 3, 0.00, 0),
...
INSERT INTO `producto` (`id_producto`, `nombre`, `marca`, `fecha_registro`, `fecha_vencimiento`, `id_motivoActualizacion`, `id_inventario`, `id_presentacion`, `id_categoria`, `enlace`, `status`) VALUES
(1, 'Refresco BigCola 2lt', 'BigCola', '2025-03-27', '2025-04-05', 1, 0, 20, 1, 'views/img/productos/Refresco BigCola 2lt.jpg', 1),
(2, 'Azucar La Pastora 1k', 'La Pastora', '2025-03-27', '2025-04-05', 1, 0, 23, 1, 'views/img/productos/Azucar La Pastora 1k.jpg', 1),
(3, 'Azucar Sabana Dulce', 'Sabana Dulce', '2025-03-27', '2025-04-05', 0, 0, 24, 1, 'views/img/productos/Azucar Sabana Dulce.jpg', 1),
(4, 'Harina de Trigo Siseca', 'Siseca', '2025-04-05', '2025-03-15', 0, 0, 25, 1, 'views/img/productos/Harina de Trigo Siseca.jpg', 1),
(5, 'Harina de Trigo La Especial', 'La Espacial', '2025-03-15', '2025-04-05', 0, 0, 25, 1, 'views/img/productos/Harina de Trigo La Especial.jpg', 1),
(6, 'Azucar La Nieve', 'La Nieve', '2025-03-15', '2025-04-05', 0, 0, 24, 1, 'views/img/productos/Azucar La Nieve.jpg', 1),
(7, 'Arroz', 'Mary', '2024-11-20', '2024-12-07', 1, 0, 1, 1, NULL, 0),
(8, 'avena', 'Waker', '2025-03-05', '2025-04-05', 2, 0, 6, 1, NULL, 0),
(9, 'pasta larga', 'waker', '2025-04-14', '2025-05-10', 0, 0, 1, 1, 'views/img/productos/logaritmo.png', 0),
(10, 'pasta', 'capri', '2025-03-27', '2025-04-05', 0, 0, 1, 1, 'views/img/productos/prueba.png', 0),
(11, 'Moises Pereira', 'natulac', '0000-00-00', '2025-06-07', 0, 0, 1, 1, NULL, 0);
...
(23, '@prueba_c', 3, '$2y$10$o9k8.N4Uhpr4FhfdpstXWeXs6VIBHdGl1mSbD7Tib4OPauI7eHmJS', 1),
...
--
ALTER TABLE `accesos`
  MODIFY `id_accesos` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=633;
...
--
ALTER TABLE `presentacion`
  MODIFY `id_presentacion` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `id_producto` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;
