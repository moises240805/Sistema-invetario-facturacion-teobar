...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 04:49:01
...
(1, 'Caja Principal efectivos y divisas', 256.36, 1),
(2, 'Caja Secundaria transferencias y pago movil', 354.76, 1);
...
(1, 23.00, 7.00, 3, 0.00, 0),
(2, 29.00, 18.00, 3, 0.00, 0),
(3, 7.00, 45.00, 4, 0.00, 0),
(7, 5.00, 12.00, 3, 1.00, 0),
(347, 9.00, 22.00, 3, 20.00, 0),
(347, 66.00, 1.10, 1, 1.00, 0),
(347, 66000.00, 22.00, 2, 1000.00, 0),
(348, 1.03, 10.00, 3, 32.00, 0),
(348, 33.00, 0.31, 1, 1.00, 0),
(348, 33000.00, 0.09, 2, 1000.00, 0),
(349, 6.00, 10.00, 3, 32.00, 0),
(349, 192.00, 0.31, 1, 1.00, 0),
(349, 192000.00, 0.16, 2, 1000.00, 0),
(350, 3.00, 12.00, 4, 0.00, 0),
...
(347, 'producto11', '2025-05-19', '0000-00-00', 0, 0, 1, 1, 1, 1234567, 1, 'views/img/productos/producto.png', 1),
(348, 'Confley Flip', '2025-05-22', '0000-00-00', 1, 0, 31, 2, 1, 1234567, 32, 'views/img/productos/ChatGPT Image 2 may 2025, 01_18_04.png', 1),
(349, 'producto 9', '2025-05-23', '0000-00-00', 0, 0, 1, 1, 1, 1234322, 32, '', 1),
...
--
ALTER TABLE `pedido`
  MODIFY `id_pedido` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
