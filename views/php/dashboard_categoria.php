...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Categorias Productos</h1>
        ...
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Gestionar Categorias Productos</h6>
    ...
    <table class="table table-bordered table-striped table-hover datatablesss" style="background-color: transparent;" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $tipo['nombre_categoria']; ?></td>
                <td>
                <a onclick="abrirModalModificar(<?php echo $tipo['ID']; ?>)" title="Modificar">
                        <img src="views/img/edit.png" width="30px" height="30px">
                    </a>
                    <a onclick="return eliminar()" href="index.php?action=categoria&a=eliminar&ID=<?php echo $tipo["ID"]; ?>" title="Eliminar">
            ...
            <?php
                            ...
                            echo "<tr><td colspan='6'>No hay categoria de productos registrados.</td></tr>";
                        } ?>
        </tbody>
    </table>
</div>
...
<div id="modalModificar" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="modalModificarLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="titulo_form text-center" id="modalModificarLabel">Modificar Categoria de Producto</h1>
                <button type="button" class="close" onclick="cerrarModalModificar()">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="formulario" action="index.php?action=categoria&a=actualizar" method="post" name="form">
                <div class="modal-body">
                    <input class="entrada" type="hidden" name="id_categoria" id="id" required>
                    <div class="form-group row">
                        <label for="categoria" class="col-md-3">Categoria Producto</label>
                        <div class="col-md-9">
                            <input class="entrada form-control" type="text" name="categoria" id="categoria"  maxlength="70"  onkeypress="return onlyLetters(event)" required>
                        </div>
                    </div>
                <div class="modal-footer justify-content-center">
    ...
    <script src="views/js/modal_categoria.js"></script>
