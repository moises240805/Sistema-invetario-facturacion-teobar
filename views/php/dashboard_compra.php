...
<div id="root">
  <header class="hero">
    ...
    <main class="main">
    <a class="hero__agg" href="crud_compra.php?action=formulario">Agregar Compra +</a>
    <h2 class="titulo">Gestionar Compras</h2>
    ...
    <table border="2px" class="table">
      <thead>
        <tr>
        <th style="background-color: rgba(0,0,0,.2);" scope="col">Nro COMPRA</th>
          <th style="background-color: rgba(0,0,0,.2);" scope="col">PRODUCTO</th>
          <th style="background-color: rgba(0,0,0,.2);" scope="col">PROVEEDOR</th>
        ...
        <tr>
          ...
          <tr>
            ...
            <a  href="#" class="btn"><img  src="views/img/delet.png" width="40px" height="40px"></a></td>
          </tr>
          <?php endforeach; ?>
        </tr>
      </thead>
