...
<b><div style="color: black; font-size:1.3rem;" id="precioDolar">Cargando...</div></b>
        ...
        <header class="container">
            <form style="margin-top: 1.5rem;" class="formulario" action="crud_proveedor.php?action=actualizar" method="post" name="form">
            <h1 class="titulo_form">Modificar Proveedor</h1><br>  
    ...
    <?php
            ...
            ?>
                <b><label for="id_proveedor">RIF del Proveedor
                <select name="tipo">
                    <option value="J-">J-</option>
                    <option value="G-">G-</option>
                </select>
                <input class="entrada" type="number" min="0" id="id2" name="id_proveedor" value=<?php echo $proveedor['id_proveedor']; ?> required oninput="validateId2()">
                </label></b>
                <span id="idError2" class="error-message"></span>
                <b><label for="nombre">Nombre del Proveedor
                <input class="entrada" type="text" id="nombrep" name="nombre" value=<?php echo $proveedor['nombre_proveedor']; ?> required oninput="validateAddress2()">
                </label></b>
                <span id="addressError2" class="error-message"></span>
                <b><label for="direccion">Direccion del Proveedor
                <input class="entrada" type="text" id="direccion" name="direccion" value=<?php echo $proveedor['direccion']; ?> required oninput="validateAddress()"> 
                </label></b>
                ...
                <input class="entrada" type="number" id="numero_tlf" name="numero_tlf" value=<?php echo $proveedor['tlf']; ?> required oninput="validatePhone()"> 
            </label></b>
            <span id="phoneError" class="error-message"></span>
                ...
                <input class="entrada" type="number" min="0" id="id" name="id_representante" value=<?php echo $proveedor['id_representante']; ?> required oninput="validateId()"> 
                </label></b>
                <span id="idError" class="error-message"></span>
                <b><label for="nombre_representante">Nombre del Representante Legal
                <input class="entrada" type="text" id="nombre" name="nombre_representante" value=<?php echo $proveedor['nombre_representante']; ?> required oninput="validateName()"> 
                </label></b>
                ...
                <input class="entrada" type="number" min="0" id="numero_tlf2" name="numero_tlf_representante" value=<?php echo $proveedor['tlf_representante']; ?> required oninput="validatePhone2()"> 
            </label></b>
