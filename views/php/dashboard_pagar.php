...
<head>
    ...
    <title>Panel Cuentas por Pagar</title>
...
<div id="root">
  <header class="hero">
    ...
    <main class="main">
    <h2 style="margin-top: 1rem;" class="titulo">Cuentas Pagar</h2>
      ...
      <thead>
        ...
        <tr>
          ...
          <tr>
            ...
            <td><a href="crud_pagar.php?action=abono&id_cuenta=<?php echo $venta['id_cuentaPagar']; ?>" style="padding:.5rem; border-radius:10px; background-color: lightgreen; color:black; text-decoration: none;">Abono</a></td>
          </tr>
          <?php endforeach; ?>
        </tr>
      </thead>
