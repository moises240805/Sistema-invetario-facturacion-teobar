...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard/ Cuentas por Pagar</h1>
        ...
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Gestionar Cuentas por Pagar</h6>
...
<div class="modal fade show" id="abonoModal" tabindex="-1" role="dialog" aria-labelledby="abonoModalLabel" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="formulario" action="index.php?action=pagar&a=abonado" method="POST" name="form">
