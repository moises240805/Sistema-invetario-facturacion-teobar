...
<head>
    ...
    <title>Panel  Tipo Productos</title>
...
<div id="root">
    ...
    <main class="main">
      <div><a style="margin-top: .5rem;" class="hero__agg" href="crud_tipo.php?action=formulario">Agregar Tipo de Producto +</a>
    <h2 class="titulo">Gestionar Tipo de Productos</h2>

      </div><?php if (!empty($message)): ?>
          <p class="alert alert-<?php echo ($message == "ELIMINADO CORRECTAMENTE") ? 'success' : 'danger'; ?>">
              <?php echo $message; ?>
          </p>
      <?php endif; ?>
      <?php if (!empty($message2)): ?>
        <p class="alert alert-<?php echo ($message2 == "ACTUALIZADO CORRECTAMENTE") ? 'success' : 'danger'; ?>">
            <?php echo $message2; ?>
        </p>
        <?php endif; ?>
      ...
      <table border="2px" class="table">
        <thead>
          <tr>
            <th style="background-color: rgba(0,0,0,.2);" scope="col">Tipo De Producto</th>
          ...
          <tr>
            ...
            <tr>
              ...
              <td><a href="crud_tipo.php?action=mid_form&id_presentacion=<?php echo $producto['id_presentacion']; ?>"><img title="Modificar" src="views/img/edit.png" width="40px" height="40px"></a>
              <a onclick="return eliminar()" href="crud_tipo.php?action=eliminar&id_presentacion=<?php echo $producto['id_presentacion']; ?>"><img title="Eliminar"  src="views/img/delet.png" width="40px" height="40px"></a><td>
            </tr>
            <?php endforeach; ?>
        </thead>
        <tbody>
