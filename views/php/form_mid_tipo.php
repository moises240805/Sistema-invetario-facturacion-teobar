...
<b><div style="color: black; font-size:1.3rem;" id="precioDolar">Cargando...</div></b>
        ...
        <main class="main">
    <header>
        <center><form class="formulario" action="crud_tipo.php?action=actualizar" method="post" name="form">
            <h1 class="titulo_form">Modificar Tipo Producto</h1>
    ...
    <?php
        ...
        ?>
            <input class="entrada" type="hidden" min="0" name="id_presentacion" readonly value=<?php echo $tipo['id_presentacion']; ?> required>
            <b><label for="username">Tipo Producto
            <input class="entrada" type="text" min="0" name="tipo_producto" value=<?php echo $tipo['tipo_producto']; ?> required>
            </label></b>
            <b><label for="pw">Presentacion
            <input class="entrada" type="text" name="presentacion" value=<?php echo $tipo['presentacion']; ?> required">
            </label></b>
